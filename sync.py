...
def get_qualified_contacts():
    ...
    payload = {
        ...
        "properties": ["email", "hs_facebook_click_id", "firstname", "lastname", "phone", "hs_lead_status", "hs_object_id"],
        "limit": 100,
    }
    ...
    while True:
        ...
        for contact in data.get("results", []):
            status = (contact.get("properties", {}).get("hs_lead_status") or "").lower()
...
def send_capi_event(contact):
    ...
    fbc = props.get("hs_facebook_click_id")
...
def main():
    ...
    for contact in contacts:
        ...
        try:
            ...
            print(f"  Contact {contact_id}: Lead event sent (events_received={result.get('events_received', 0)})")
            success += 1
